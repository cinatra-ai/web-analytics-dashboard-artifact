...
// Host-faithful sync (cinatra-ai/cinatra#2005): the authoritative host artifact
// allowlist (packages/extensions/src/artifact-handler.validate) admits
// `fieldRenderers` and the `dashboardContribution` dashboard-contribution carrier
// alongside `views`. The cinatra-cli canonical mirror of this gate had not yet
// re-synced those two keys; this repo (the FIRST dashboardContribution meaning
// pack) ships the host-faithful set so its `cinatra.dashboardContribution` claim
// is not rejected by its own pre-publish gate. Follow-up: re-sync the cinatra-cli
// canonical + the release-tooling ERT mirror to this exact set.
